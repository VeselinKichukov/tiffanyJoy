<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <!-- blog template -->
    <link rel="stylesheet" type="text/css" href="css/primorsko.css">
  ...
  <body>
    ...
    <section class="banner-section">
      ...
      <!-- <img src="img/blog/primorsko-cover.jpg" alt=""> -->
    </section>
...
line-height: 1.4em; -->
                ...
                <div class="col-lg-9 col-md-9 col-sm-12" >
                     ...
                     <!-- <div class="image-block1" style='height: 100%; width: 100%; object-fit: contain'>
                ...
                <div class="col-lg-3  col-md-3 col-sm-12">
                    ...
                    <div class="well">
                      <h3>{!! trans('home.primorsko_appartments') !!}</h3>
                        <div class="media"> <div class="media-left"> <a href="#"> <img data-src="../img/blog/primosrsko_house.jpg" class="media-object" alt="64x64" width='200px' height='200px' src="{{ asset('../img/blog/primosrsko_house.jpg') }}" data-holder-rendered="true"> </a> </div> <div class="media-body"> <h5 class="media-heading">{!! trans('home.primorsko_house_name') !!}</h5>In the centre of Pomorie and only 50 metres away from the beach.</div> </div>
                    ...
                    <div class="well">
                      ...
                      <div class="list-group">
                        <a class="list-group-item" href="/pomorie"> <h4 class="list-group-item-heading">Pomorie</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a>
                        <a class="list-group-item" href="/sinemorets"> <h4 class="list-group-item-heading">Sinemorets</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a>
                        <a class="list-group-item active" href="/primorsko"> <h4 class="list-group-item-heading">Primorsko</h4> <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p> </a>
                      </div>
                    </div>
                </div>
            </div>
