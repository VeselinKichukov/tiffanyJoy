                ...
                <button class="btn btn-default" type="button">Go!</button>
                        ...
                        <div class="well">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body"><h4 class="media-heading">Guest House More</h4>In the centre of
                                                                                                       Pomorie and only
                                                                                                       50 metres away
                                                                                                       from the beach.
                                </div>
                        ...
                        <div class="well">
                            ...
                            <div class="list-group">
                                ...
                                <a class="list-group-item" href="#"><h4 class="list-group-item-heading">Sinemorets</h4>
                                    <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus.
                                                                    Maecenas sed diam eget risus varius blandit.</p></a>
                                <a class="list-group-item" href="#"><h4 class="list-group-item-heading">Primorsko</h4>
                                    <p class="list-group-item-text">Donec id elit non mi porta gravida at eget metus.
                                                                    Maecenas sed diam eget risus varius blandit.</p></a>
                            </div>
                        </div>
